...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I ./include/ -I ./../docs/common/thirdparty/old/glm"
    LIBRARIES="-lSDL2 -ldl"
elif platform.system()=="Darwin":
    ARGUMENTS="-D MAC" # -D is a #define sent to the preprocessor.
    INCLUDE_DIR="-I ./include/ -I/Library/Frameworks/SDL2.framework/Headers -I./../docs/common/thirdparty/old/glm"
